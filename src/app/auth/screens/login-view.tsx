...
const LoginView = ({ navigation }: Props) => {
    ...
    useEffect(() => {
        ...
        } else if (isValid.password === false) setWrongPassword(!wrongPassword)
    ...
    return (
        <SafeAreaView style={styles.container}>
            <Animated.View style={styles.logoContentContainer}>
                <Image
                    source={require('../../../assets/images/ocean-tech-logo.png')}
                    style={styles.logo}
                    />
            </Animated.View>
            <Animated.View style={styles.loginContentContainer}>
