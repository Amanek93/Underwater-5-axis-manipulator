...
export function reducer(state: HomeState = initialState, action: HomeAction): HomeState {
    switch (action.type) {
        case HomeActionTypes.ADD_SPEED:
            return {
                ...state,
                device: { ...state, speed: state.device.speed + 1 },
            };
        ...
        case HomeActionTypes.RESET_SPEED:
            return {
                ...state,
                device: { ...state, speed: initialState.device.speed },
            };
        case HomeActionTypes.ADD_AXIS1:
            return {
                ...state,
                device: { ...state, axialRadius1: state.device.axialRadius1 + 1 },
            };
        ...
        case HomeActionTypes.RESET_AXIS1:
            return {
                ...state,
                device: { ...state, axialRadius1: initialState.device.axialRadius1 },
            };

        case HomeActionTypes.ADD_AXIS2:
            return {
                ...state,
                device: { ...state, axialRadius2: state.device.axialRadius2 + 1 },
            };
        ...
        case HomeActionTypes.RESET_AXIS2:
            return {
                ...state,
                device: { ...state, axialRadius2: initialState.device.axialRadius2 },
            };
        case HomeActionTypes.ADD_AXIS3:
            return {
                ...state,
                device: { ...state, axialRadius3: state.device.axialRadius3 + 1 },
            };
        ...
        case HomeActionTypes.RESET_AXIS3:
            return {
                ...state,
                device: { ...state, axialRadius3: initialState.device.axialRadius3 },
            };
        case HomeActionTypes.ADD_AXIS4:
            return {
                ...state,
                device: { ...state, axialRadius4: state.device.axialRadius4 + 1 },
            };
        ...
        case HomeActionTypes.RESET_AXIS4:
            return {
                ...state,
                device: { ...state, axialRadius4: initialState.device.axialRadius4 },
            };
        case HomeActionTypes.ADD_AXIS5:
            return {
                ...state,
                device: { ...state, axialRadius5: state.device.axialRadius5 + 1 },
            };
        ...
        case HomeActionTypes.RESET_AXIS5:
            return {
                ...state,
                device: { ...state, axialRadius5: initialState.device.axialRadius5 },
            };
        default:
            return state;
    }
